# Caledros Basic Theme - WordPress Theme
...
- Sidebar Menu. This template part controls the sidebar menu that is only visible on small screen and touchscreen devices. The user can add links, images, buttons, and in general any kind of block inside this template part.
...
**1.1. Inter**, _Copyright 2020 [The Inter Project Authors](https://github.com/rsms/inter)_
...
**1.2. Ephesis**, _Copyright 2004-2021 [The Ephesis Project Authors](https://github.com/googlefonts/ephesis)_
...
Photo by _Peter Heeling_. Used under the **Creative Commons CC0 license**.
...
Photo by _Rudy van der Veen_. Used under the **Creative Commons CC0 license**.
...
Photo by _Cristian Ungureanu_. Used under the **Creative Commons Zero (CC0) license**.
...
Downloaded from _pxere.com_. Used under the **CC0 Public Domain license**.
...
Photo by _World Travel Adventures_. Used under the **Creative Commons Zero (CC0) license**.
...
Photo by _Free Nature Stock_. Used under the **Creative Commons Zero (CC0) license**.
...
Photo by _Matt Bango_. Used under the **Creative Commons Zero (CC0) license**.
