 ...
 * Slug: caledros-basic-theme/call-to-action-2
 * Categories: caledros-basic-theme/call-to-action
 */
?>

<?php
$image_url = get_template_directory_uri() . '/assets/images/patterns/trees.webp';
if (!filter_var($image_url, FILTER_VALIDATE_URL)) { 
    $image_url = ''; 
}
?>

<!-- wp:caledros-basic-blocks/flex-container {"containerWidth":"var(\u002d\u002dwp\u002d\u002dstyle\u002d\u002dglobal\u002d\u002dcontent-size)","containerMinHeight":"300px","containerLightBackgroundColor":"#00000066","containerDarkBackgroundColor":"#00000066","containerBackgroundImage":{"id":1137,"alt":"","url":"<?php echo esc_url($image_url); ?>"},"containerBgImageFocalPoint":{"x":0.47,"y":0.35},"containerBorder":{"style":"none","width":"0px","lightColor":"#00000000","darkColor":"#00000000","radius":"40px"},"containerFlexDirection":{"desktop":"row","tablet":"row","mobile":"column"},"metadata":{"categories":["caledros-basic-theme/call-to-action"],"patternName":"caledros-basic-theme/call-to-action-2","name":"Call to Action 2"}} -->
